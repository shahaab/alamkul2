...
// function myFunction() {
//   var radioL = document.getElementById("switch_left1");
//   var radioR = document.getElementById("switch_right1");
//   var categories = document.getElementById("elite1");
//   var alphabetical = document.getElementById("basic1");
//   if (radioL.checked == true){
//      elite1.style.display = "block";
//   } else {
//      elite1.style.display = "none";
//   }
// if (radioR.checked == true){
